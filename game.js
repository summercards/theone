/* =============================================================
   ...
   wx.onTouchMove (e => currentPageModule?.touchmove?.(e));   // ✅ 修复：去掉 ?. 与 ( 之间的空格
   wx.onTouchEnd  (e => currentPageModule?.touchend?.(e));    // ✅ 修复：去掉 ?. 与 ( 之间的空格
   ...
   function loop(timestamp) {
     ...
     try {
       ...
       currentPageModule.draw?.(ctx);                         // ✅ 修复：去掉 ?. 与 ( 之间的空格
     } catch (err) {
